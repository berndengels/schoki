...
trait MySortableTrait
{
	...
	{
		return $this->mySiblings(false, $limit);
	}
	...
	{
		return $this->mySiblings(true, $limit);
	}
	 ...
	 * @return QueryBuilder
	 */
	public function mySiblings($isNext, $limit = 0)
	{
		$sortableField = static::getSortableField();
