...
mix.autoload({
    ...
    .copy('resources/vendor/calendar@1', 'public/vendor/calendar@1')
    .copy('resources/vendor/calendar@2/dist', 'public/vendor/calendar@2')
//    .copy('resources/vendor/calendar@2/zabuto_calendar.min.js', 'public/vendor/calendar/js')
