<div id="top-navigation">
    <nav class="navbar fixed-top navbar-expand-md navbar-dark bg-black">
        <a class="navbar-brand" href="/events">
            <img src="{{ mix('img/batcow_yellow.png') }}">
            <img src="{{ mix('img/schokoladen_schrift_yellow.png') }}"></a>
        ...
        <div class="d-sm-none d-lg-block float-right my-auto mr-3">
            <img src="{{ mix('img/power/address.png') }}" width="183" height="14" alt="Schokoladen, Ackerstraße 169, 10115 Berlin" title="Schokoladen, Ackerstraße 169, 10115 Berlin" />
        </div>
    </nav>
</div>
